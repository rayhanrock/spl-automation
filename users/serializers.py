...
import random
from . import models
from .utils import send_otp_via_email, validate_student_email, validate_teacher_email
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.UserProfile
        fields = ['username', 'first_name', 'last_name', 'email', 'roll', 'password', 'confirm_password', 'is_teacher',
                  'is_student']
    ...
    def create(self, validated_data):
        ...
        send_otp_via_email(email, otp)
        models.Student.objects.create(user_profile=user, roll=roll)
